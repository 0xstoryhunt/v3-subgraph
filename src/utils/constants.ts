...
export const SECONDS_PER_YEAR = BigDecimal.fromString('31536000') // 365 * 24 * 60 * 60
  ...
  export const STABLECOIN_WRAPPEDNATIVE_POOLADDRESS = '0xc56c1be28a22ced0270a4d2f45753d2b6300c1ae' //@NOTE: ALWAYS LOWERCASE //WIP-USDC 0.3% pool //Recomended WIP-USDC 0.05% pool
...
export const STORY_MAINNET_NAME = 'story-mainnet'
